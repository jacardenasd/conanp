...
$countStmt = $pdo->prepare("SELECT COUNT(*) FROM unidades{$whereSql}");
...
$listStmt = $pdo->prepare("SELECT * FROM unidades{$whereSql} ORDER BY nombre ASC LIMIT {$rowsPerPage} OFFSET {$offset}");
        ...
        <div class="content-inner">
            ...
            <div class="content">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3">
                    <h2 class="mb-0">Administrar Unidades</h2>
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#modalAgregar">Agregar unidad</button>
                </div>
                    ...
                    <div class="card-body">
                        <form method="get" class="row g-3 align-items-end">
                            <div class="col-md-10">
                                ...
                                <input type="text" id="q" name="q" class="form-control" placeholder="Nombre de unidad" value="<?= htmlspecialchars($busqueda) ?>">
                            </div>
                            <div class="col-md-2 d-flex gap-2">
                                <button type="submit" class="btn btn-primary w-100">Filtrar</button>
                                <a href="admin_unidades.php" class="btn btn-light w-100">Limpiar</a>
                            </div>
                        </form>
                    </div>
                </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    ...
                                    <div class="modal fade" id="modalEditar<?= (int)$u['id'] ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form method="post" action="unidades_editar.php">
                                    ...
                                    <div class="modal fade" id="modalEliminar<?= (int)$u['id'] ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <form method="post" action="unidades_eliminar.php">
                                                    <div class="modal-header bg-danger text-white">
                                                        <h6 class="modal-title">Confirmar eliminación</h6>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        ¿Deseas eliminar la unidad <strong><?= htmlspecialchars($u['nombre']) ?></strong>?
                                                        <input type="hidden" name="id" value="<?= (int)$u['id'] ?>">
                                                    </div>
                                                    <div class="modal-footer">
                                    ...
                                    <tr>
                                        <td colspan="3" class="text-center text-muted">No se encontraron unidades.</td>
                                    </tr>
                                    <?php endif; ?>
                                </tbody>
                            </table>
                        ...
                        <nav aria-label="Paginación unidades" class="mt-3">
                            <ul class="pagination pagination-sm mb-0">
                                ...
                                <li class="page-item <?= $paginaActual >= $totalPaginas ? 'disabled' : '' ?>">
                                    ...
                                    <a class="page-link" href="admin_unidades.php?<?= $nextQuery ?>">Siguiente</a>
                                </li>
                            </ul>
                        </nav>
                        <?php endif; ?>
                ...
                <div class="modal fade" id="modalAgregar" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <form method="post" action="unidades_agregar.php">
                                <div class="modal-header bg-success text-white">
                                    <h6 class="modal-title">Nueva unidad</h6>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                                </div>
                                <div class="modal-body">
