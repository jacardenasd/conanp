...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (isset($_POST['editar'])) {
		...
		$stmt = $pdo->prepare("UPDATE actividades_extraordinarias SET validado = 1, estatus = 2, comentarios = ? WHERE id = ?");
        $stmt->execute([$comentarios, $id]);

		header("Location: cols_actividades_extraordinarias.php?info=1&colaborador_id=$colaborador_id&periodo=$periodo");
        exit();
    }
}

//solo muestra actividades destacadas que tienen archivo de comprobación cargado por el usuario
			...
			<div class="content-inner">
				...
				<?php if (isset($_GET['info'])): ?>
					...
					<div class="card-body d-flex">
						...
						<p class="card-text small mb-0">Aquí podrás cargar tus Actividades Extraordinarias.</p>
						</div>
					</div>
					</div>	
						...
						<div class="col-lg-10">
							<div class="card">
								<div class="card-header">
									...
									<div class="card-body">
									<p>Se refiere a los encargos temporales del despacho, La suplencia de personas servidoras públicas en el ejercicio de atribuciones para el cumplimiento de los objetivos institucionales, que resulten significativas para el desarrollo del capital humano y, en su caso, contribuyan a la mejora de la CONANP.</p>
									<p>Recuerda que, al terminar el proceso de actividades extraordinarias, deberás dar clic en el botón de "terminar". Una vez que hayas terminado, ya no se podrá editar la información.</p>
									</div>
							</div>
            			</div>
						...
						<div class="col-lg-2">
							<div class="card">
                				...
                				<div class="card-body text-center">
									<p>Las actividades extraordinarias se validan una vez que el superior jerárquico las aprueba.</p>
...
<div class="modal-dialog">
	<div class="modal-content">
  <form method="post" action="cierre_periodo_actividades_extraordinarias.php">
    <div class="modal-header">
